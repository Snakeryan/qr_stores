        ...
        function() {
            ...
            function O(a, b, c) {
                try {
                    let d = z(a, { x: -1, y: a.y }, c, b.length),
                        ...
                        f = z(
                            a, { x: Math.max(0, a.x - a.y) - 1, y: Math.max(0, a.y - a.x) - 1 },
                            c,
                            b.length
                        ),
                        g = z(
                        ...
                        m = F(g, b),
                        l =
                        (h.averageSize + k.averageSize + n.averageSize + m.averageSize) /
                        4;
                    return (
                        Math.sqrt(
                            h.error * h.error +
            ...
            function ka(a) {
                ...
                for (let m = 0; m <= a.height; m++) {
                    ...
                    b.push(
                        ...c.filter((a) => a.bottom.y !== m && 2 <= a.bottom.y - a.top.y)
                    );
                ...
                for (var m of b)
                    ...
                    ((b =
                            (m.top.startX + m.top.endX + m.bottom.startX + m.bottom.endX) /
                            4),
                    ...
                    for (var l = 0; l < c; l++)
                        for (var p = 0; p < b; p++) {
                            ...
                            m.set(
                                p,
                                l,
                                (g.red * a[q] + g.green * a[q + 1] + g.blue * a[q + 2] + 128) >>
                                8
                            );
                        }
                else
                    for (l = 0; l < c; l++)
                        for (p = 0; p < b; p++)
                            ...
                            m.set(
                                p,
                                l,
                                g.red * a[q] + g.green * a[q + 1] + g.blue * a[q + 2]
                            );
                g = Math.ceil(b / 8);
                l = Math.ceil(c / 8);
                p = g * l;
...
class QrScanner {
    static hasCamera() {
        return QrScanner.listCameras(!1)
            .then((a) => !!a.length)
            .catch(() => !1);
    }
            ...
            l = Promise.all([
                ...
                return c instanceof Worker ?
                    ...
                    new Promise((a, b) => {
                        ...
                        c.detect(d)
                            .then((c) => {
                                // console.log("canvas width and height", c[0] ? c[0] : c, d);
                                if (c[0]) {
                                    // const cornerPoints = c[0].cornerPoints;
                                    // const context = d.getContext("2d");
                                    // context.beginPath();
                                    // context.moveTo(cornerPoints[0].x, cornerPoints[0].y);
                                    // context.lineTo(cornerPoints[1].x, cornerPoints[1].y);
                                    // context.lineTo(cornerPoints[2].x, cornerPoints[2].y);
                                    // context.lineTo(cornerPoints[3].x, cornerPoints[3].y);
                                    // context.lineTo(cornerPoints[0].x, cornerPoints[0].y);
                                    // context.stroke();
                                    // const centerX =
                                    //     (cornerPoints[0].x +
                                    //         cornerPoints[1].x +
                                    ...
                                    //     centerY
                                    // );
                                    // const qrWidth = c[0].boundingBox.width;
                                    // const qrHeight = c[0].boundingBox.height;
                                    // const percentWidth = (qrWidth / d.width) * 100;
                                    // const percentHeight = (qrHeight / d.height) * 100;
                                    // let elementTable = document.querySelector("#elementTable");
                                    // let hasElementTable = true;
                                    // if (!elementTable) {
                                    //     hasElementTable = false;
                                    //     elementTable = document.createElement("div");
                                    //     elementTable.id = "elementTable";
                                    //     elementTable.innerHTML = `
                                    // <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0" class="scrollspy" tabindex="0">
                                    //     <div class="table-responsive tableContainer">
                                    //         <table class="table align-middle">
                                    //             <thead class="table-dark sticky-top">
                                    //                 <tr>
                                    //                     <th scope="col">Image</th>
                                    //                     <th scope="col">Percent Width</th>
                                    //                     <th scope="col">Percent Height</th>
                                    ...
                                    //     elementTable.querySelector(`.tableBody`);
                                    // const imageAnalyticsRow = document.createElement("tr");
                                    // const imageTd = document.createElement("td");
                                    // d.style.height = "300px";
                                    // d.style.width = "300px";
                                    // imageTd.append(d);
                                    // const widthTd = document.createElement("td");
                                    // widthTd.append(percentWidth.toPrecision(6));
                                    // const heightTd = document.createElement("td");
                                    // heightTd.append(percentHeight.toPrecision(6));
                                    ...
                                    //     document.createElement("br")
                                    // );
                                    // imageAnalyticsRow.append(
                                    //     imageTd,
                                    //     widthTd,
                                    //     heightTd,
                                    //     cornerTd
                                    // );
                                    // elementTableBody.append(imageAnalyticsRow);
                                    // // document.body
                                    // //     .append
                                    // //     // document.createElement("br"),
                                    // //     // "percent of screen: ",
                                    // //     // (c[0].boundingBox.width / d.width) * 100,
                                    // //     // "%         ",
                                    // //     // (c[0].boundingBox.height / d.height) * 100,
                                    // //     // "%",
                                    // //     // document.createElement("br"),
                                    // //     // d,
                                    // //     // document.createElement("br")
                                    // //     ();
                                    // // if (!hasElementTable) {
                                    // //     document.body.append(elementTable);
                                    // // }
                                    // // console.log(d.width, d.height);
                                    // // console.log(c);
                                    // // console.log(
                                    // //     "percent of screen: qrsize",
                                    // //     percentWidth,
                                    // //     "         ",
                                    // //     percentHeight
                                    // // );
                                    // const completeDiagonal = Math.sqrt(
                                    //     d.width ** 2 + d.height ** 2
                                    // );
                                    // const qrDiagonal = Math.sqrt(qrWidth ** 2 + qrHeight ** 2);
                                    // const percentDiagonal = qrDiagonal / completeDiagonal;
                                    // // console.log("diagonal ", percentDiagonal);
                                    // QrScanner.qrCoordinates = { centerX, centerY };
                                    // QrScanner.qrSize = {
                                    //     percentWidth,
                                    //     percentHeight,
                                    //     percentDiagonal,
                                    // };
                                    // console.log("qrSize", QrScanner.qrSize);
                                }
                                // context.beginPath();

                                c.length ? a(c[0].rawValue) : b(QrScanner.NO_QR_CODE_FOUND);
                            })
                            .catch((a) => b("Scanner error: " + (a.message || a), a))
                            .finally(() => clearTimeout(g));
                    });
            });
        b && h && (l = l.catch(() => QrScanner.scanImage(a, null, c, d, g)));
        return (l = l.finally(() => {
            k || QrScanner._postWorkerMessage(c, "close");
        }));
    }
    ...
    setInversionMode(a) {
        QrScanner._postWorkerMessage(this._qrEnginePromise, "inversionMode", a);
    }
    static createQrEngine(a = QrScanner.WORKER_PATH) {
        return (
            ...
            //////////asals;kdfj;laksdjf;laskdfj;lksdjf;lkj;lj
        );
    }
    _onPlay() {
    ...
    _onDecodeError(a) {
        a !== QrScanner.NO_QR_CODE_FOUND && console.log(a);
    }
    _getCameraStream() {
    ...
    static _loadImage(a) {
        ...
        if (
            ...
            return QrScanner._awaitImageLoad(b).then(() => {
