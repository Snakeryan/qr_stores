...
function() {
    ...
    ((p = "undefined" != typeof jQuery && jQuery ? jQuery : {}).csv = {
        ...
        toArrays: function(r, e, a) {
            ...
            if (
                (void 0 !==
                    ...
                    void 0 !== e.onPostParse && (o = e.onPostParse(o, e.state)), !t.callback)
            )
                return o;
            t.callback("", o);
        },
        toObjects: function(r, e, a) {
            ...
            if (
                (void 0 !== e.onPostParse && (s = e.onPostParse(s, e.state)), !t.callback)
            )
                return s;
            t.callback("", s);
        },
        fromArrays: function(r, e, a) {
            ...
            for (n = 0; n < r.length; n++) {
                for (o = r[n], s = [], i = 0; i < o.length; i++) {
                    ...
                    var c = "\n|\r|S|D";
                    (c = (c = c.replace("S", t.separator)).replace("D", t.delimiter)), -1 < u.search(c) && (u = t.delimiter + u + t.delimiter),
                        s.push(u);
                }
